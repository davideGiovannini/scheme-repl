...
(define (assq obj alist)     (fold (mem-helper (curry eq? obj) head) #f alist))
(define (assv obj alist)     (fold (mem-helper (curry eqv? obj) head) #f alist))
(define (assoc obj alist)    (fold (mem-helper (curry equal? obj) head) #f alist))
